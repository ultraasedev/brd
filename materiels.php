		...
		<main>
					...
					<div class="container-fluid">
						<div class="row align-items-center">
							<div class="fluid-text-img">
								<div class="img-wrap">
									<img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" class="text-img lazy" data-src="./img/tile-text-0.jpg" alt="bg">
								</div>
							</div>
							<div class="offset-md-6 col-md-6 pt-xs-50 pt-md-50 pt-lg-120">
								<div class="text-block">
									<h2>Qu'utilisons-nous pour vous offrir une Top Qualité ?</h2>
									<p class="h-sub">BraizeRecords esseye d'offrir au client le top en matière d'équipement pour son studio</p>
									<p>Pour avoir une idée plus complète de l'équipement disponible dans notre studio, veuillez consulter ci-dessous notre liste complète des équipements de studio d'enregistrement. Chaque équipement que nous possédons se trouve ici sur cette liste, et nous le mettons à jour régulièrement pour de nouveaux ajouts (nous nous adaptons toujours au paysage musical changeant).</p>
								</div>
							</div>
						</div>
					</div>
			...
			<section class="pt-xs-25 pt-md-25 pt-lg-60">
				<div class="tile-list">
					...
					<div class="tile-list__item tile-list__item">
						<div class="tile-list-text">
							<div class="tile-list-content">
								<h3>Monitoring</h3>
								<ul>
									<li>
										<p>Adam T5V ( Control Room A)</p>
									</li>
					...
					<div class="tile-list__item tile-list__item--dark">
						<div class="tile-list-text">
							<div class="tile-list-content">
								...
								<ul>
									<li>
										<p>Asus Rog I7-H  4 coeurs ; 8 threads (Control Room A)</p>
									</li>
									<li>
										<p>Pro Tools 12 HD(Control Room A)</p>
									</li>
								</ul>
							</div>
						</div>
