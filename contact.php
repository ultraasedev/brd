<?php include "inc/_header.php";?>
		...
		<main>
			...
			<section class="v-separator pb-xs-50 pb-md-50 pb-lg-120">
				<div class="map-block" id="contact-map" data-lng='-117.2697074' data-lat='34.0887252' data-zoom='15' data-map-icon="./img/map-marker.png"></div>
						...
						<ul class="contact-list">
							<li class="mb-xs-30 mb-lg-50">
								...
								<div class="contact-list_text">
									<h5>BraizeRecords</h5>
									<a href="https://goo.gl/maps/xASKMUdDFLf5ZY6Q6" target="_blank">XX Rue XXXX<br>35000, CA Rennes</a>
								</div>
							</li>
							<li class="mb-xs-30 mb-lg-50">
								<div class="contact-icon">
								...
								<div class="contact-list_text">
									<h5>Contact </h5>
									<a href="tel:07.80.62.06.05">07.80.62.06.05</a>
									<a href="mailto:contact@braizerecords.fr">contact@braizerecords.fr</a>
								</div>
							</li>
							<li class="mb-xs-30 mb-lg-50">
								<div class="contact-icon">
								...
								<div class="contact-list_text">
								<h5>Horaires</h5>
									<p>Lundi - Vendredi : 9:00  - 23:00</p>
									<p>Samedi - Dimanche : 8:30  - 00:00 </p>
								</div>
							</li>
						</ul>
					</div>
					...
					<div class="row">
						<div class="col-lg-6 pt-xs-25 pt-md-25 pt-lg-60">
							<div class="contact-text">
								...
								<ul>
									<li>
										<p>Nous proposons service d'accompagnement artistique. Veuillez contacter<a href="mailto:carriere@braizerecords.co" class="theme-color">carriere@braizerecords.com</a> pour plus d'informations.</p>
									</li>
									<li>
										<p>Vous pouvez écouter et contribuer à une session d'enregistrement BraizeRecords via Skype. Veuillez ajouter le nom Skype "BraizeRecords" (sans les guillemets) à votre liste de contacts..</p>
									</li>
									<li>
										<p>Vous pouvez visiter le studio  ou venir discuter de vos projets, en nous envoyer un e-mail à <a href="mailto:reservation@braizerecords.com" class="theme-color">reservation@braizerecords.com</a></p>
									</li>
								</ul>
								<h3>Newsletter</h3>
								<p>Restez au courant de ce qui se passe chez BraizeRecords.</p>
								<form action="#" class="newsletter-form" id="newsletterform" method="post" novalidate="novalidate">
									<input type="text" name="email" placeholder="Entre ton Adresse E-Mail">
							...
							<form action="#" class="contact-form" id="contactform"  method="post" novalidate="novalidate">
		                        ...
		                        <span class="selectWrapper">
		                            <select name="my-select-country" class="tt-custom-select form-control">
		                                <option value="# ">Quelle service veux tu joindre?</option>
		                                <option value="studio">Service Studio</option>
		                                <option value="label">Service Label</option>
										<option value="film">Service Films/Court & Long-Metrage</option>
										<option value="Commercial">Service Commercial</option>
										<option value="Communication">Service Communication</option>
										<option value="WebMaster">Service WebMaster</option>
										<option value="Autres">Autre(s)</option>
