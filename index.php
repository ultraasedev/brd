			...
			<div class="main-slider" 
					...
					<div class="container">
						<div class="row">
							<div class="col-12 text-center">
								<p class="tt-slide_description">Go Shade From to Light.</p>
								<p class="tt-slide_header"><span class="font-gradient">donne vie à ta</span><br>créativité</p>
				...
				<div class="tt-slide">
					...
					<div class="container">
						<div class="row">
							<div class="col-12 text-center">
								<p class="tt-slide_header"><span class="font-gradient">Un Projet Artistique?</span><br>No Problem. Une BraizeSolution</p>
...
<main class="pt-xs-25 pt-md-25 pt-lg-60">
			...
			<section class="white-section parralax-section v-separator pb-xs-25 pb-md-25 pb-lg-60">
						...
						<div class="row flex-row-reverse align-items-center">
							<div class="col-md-6">
								<div class="text-section_video">
									<h2>Bienvenue sur le site de BraizeRecords .</h2>

									<a data-fancybox href="#" class="img-wrap js-tilt">
										<img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" class="text-img lazy" data-src="./img/text-block-video-1.png" alt="bg">
									<img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" class="text-img-bg lazy" data-src="./img/text-block-video-bg.png" alt="img">
	  			                      </a>
								</div>
							</div>
							<div class="col-md-6">
								<div class="text-block">
									<h2>Bienvenue sur le site de BraizeRecords .</h2>
									<p class="h-sub">Nous savons que pour faire de la bonne musique, vous avez besoin d'un cadre idéal .</p>
									<p>une combinaison d&rsquo;équipement haut de gamme, des espaces de travail et de salon confortables, un cadre relaxant et une équipe compétente , à l'écoute de vos projets et capable de travailler avec des artistes de tout niveau</p>
									<p>Un endroit où le développement artistique est encouragé et les prix attractifs, une qualité jamais sacrifiée pour le plus grand repesct des clients.</p>
									<img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" class="lazy" data-src="./img/sign.png" alt="bg">
								</div>
							</div>
						</div>
					</div>
				...
				<img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" class="parallax-img animate tt-paroller lazy" data-src="img/paralax.png" data-paroller-factor="0.15" data-paroller-type="foreground" alt="bg">
			</section>
			<!-- End text-section -->
			<!-- Begin record studio -->
			<section class="dark-section v-separator pt-xs-50 pt-md-50 pt-lg-120 pb-xs-50 pb-md-50 pb-lg-120">
				<div class="container">
					<div class="section-header white">
						<h2>Le Studio</h2>
						<p>quelque clichés du studio </p>
					</div>
				</div>
				<div class="studio-slider white-arrow"
					 data-slick='{
					 	"centerMode": true,
					 	"centerPadding": "29.5%",
					 	"responsive": [
						...
						<div class="studio-info">
							<div class="studio-info_text">
								...
								<div class="studio-info_footer">
									<p>Our 30m2 tracking room hosts a pristine Neve VR36 console with Flying Faders, ATC monitors, Prism ADA-8XR’s converters and a stunning rack of world class outboard.</p>
								</div>
							</div>
							<picture>
					...
					<div class="tt-slide">
						<div class="studio-info">
							<div class="studio-info_text">
								<h4><span class="color-main">Studio C</span> – Trackiеng Studio</h4>
								<div class="studio-info_footer">
									<p>Our 30m2 tracking room hosts a pristine Neve VR36 console with Flying Faders, ATC monitors, Prism ADA-8XR’s converters and a stunning rack of world class outboard.</p>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-12">
								<div class="section-header">
									<h2>Réalisations</h2>
									<p>Voici nos dernieres Réalisations</p>
								</div>
								<div class="project-slider arrow-outside"
									...
									<div class="tt-slide">
										<div class="project-card">
											...
											<a href="#" class="project-cart_name">Tindo</a>
											<p class="theme-color">Cup</p>
										</div>
									</div>
									<div class="tt-slide">
										<div class="project-card">
											...
											<a href="#" class="project-cart_name">Kenshin</a>
											<p class="theme-color">H24</p>
										</div>
									</div>
									<div class="tt-slide">
										<div class="project-card">
					...
					<div class="row">
						<div class="col-12">
							...
							<div class="review-author">
									<div class="avatar">
										<img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" class="lazy" data-src="img/review-1.jpg" alt="img" height="60px" width="60px">
									</div>
			...
			<section class="white-section parralax-section pt-xs-25 pt-md-25 pt-lg-60 pb-xs-25 pb-md-25 pb-lg-60">
				<div class="container pt-xs-25 pt-md-25 pt-lg-60 pb-xs-25 pb-md-25 pb-lg-60">
					<div class="row">
						<div class="col-12">
							...
							<div class="news-slider arrow-outside"
								 data-slick='{
								 	"slidesToShow": 3,
								 	"swipeToSlide": true,
								 	"adaptiveHeight": true,
								...
								<div class="tt-slide pb-xs-15">
									<div class="news-card">
										<a href="blog-post.php" class="news-cart_logo">
											<img src="img/news-1.jpg" alt="img">
										</a>
										<div class="news-card_description">
											<time datetime="2019-10-10">
												<svg width="15" height="16" viewBox="0 0 15 16" xmlns="http://www.w3.org/2000/svg"><path d="M7.5 0.937988C6.46484 0.937988 5.49316 1.13818 4.58496 1.53857C3.67676 1.9292 2.88086 2.46631 2.19727 3.1499C1.52344 3.82373 0.986328 4.61475 0.585938 5.52295C0.195313 6.43115 0 7.40283 0 8.43799C0 9.47314 0.195313 10.4448 0.585938 11.353C0.986328 12.2612 1.52344 13.0571 2.19727 13.7407C2.88086 14.4146 3.67676 14.9468 4.58496 15.3374C5.49316 15.7378 6.46484 15.938 7.5 15.938C8.53516 15.938 9.50684 15.7378 10.415 15.3374C11.3232 14.9468 12.1143 14.4146 12.7881 13.7407C13.4717 13.0571 14.0088 12.2612 14.3994 11.353C14.7998 10.4448 15 9.47314 15 8.43799C15 7.40283 14.7998 6.43115 14.3994 5.52295C14.0088 4.61475 13.4717 3.82373 12.7881 3.1499C12.1143 2.46631 11.3232 1.9292 10.415 1.53857C9.50684 1.13818 8.53516 0.937988 7.5 0.937988ZM7.5 14.4438C6.67969 14.4438 5.90332 14.2876 5.1709 13.9751C4.43848 13.6528 3.79883 13.2231 3.25195 12.686C2.71484 12.1392 2.28516 11.4995 1.96289 10.7671C1.65039 10.0347 1.49414 9.2583 1.49414 8.43799C1.49414 7.61768 1.65039 6.84131 1.96289 6.10889C2.28516 5.37646 2.71484 4.7417 3.25195 4.20459C3.79883 3.65771 4.43848 3.22803 5.1709 2.91553C5.90332 2.59326 6.67969 2.43213 7.5 2.43213C8.32031 2.43213 9.09668 2.59326 9.8291 2.91553C10.5615 3.22803 11.1963 3.65771 11.7334 4.20459C12.2803 4.7417 12.71 5.37646 13.0225 6.10889C13.3447 6.84131 13.5059 7.61768 13.5059 8.43799C13.5059 9.2583 13.3447 10.0347 13.0225 10.7671C12.71 11.4995 12.2803 12.1392 11.7334 12.686C11.1963 13.2231 10.5615 13.6528 9.8291 13.9751C9.09668 14.2876 8.32031 14.4438 7.5 14.4438ZM7.88086 4.68799H6.75293V9.18506L10.6494 11.5874L11.25 10.606L7.88086 8.58447V4.68799Z"/></svg>10.06.2020
											</time>
											<a href="blog-post.php" class="news-cart_name">Ouverture</a>
											<p>decouvre dès a présent notre site internet,son histoire,c'est fonctionnalités....</p>
											<a href="blog-post.php" class="read-more">
												<svg width="9" height="10" viewBox="0 0 9 10" xmlns="http://www.w3.org/2000/svg"><path d="M1.47188 0.337891C1.06823 0.103516 0.723177 0.0709635 0.436719 0.240234C0.150261 0.402995 0.00703144 0.71875 0.00703144 1.1875V8.0625C0.00703144 8.53125 0.150261 8.84701 0.436719 9.00977C0.723177 9.17253 1.06823 9.13997 1.47188 8.91211L7.4875 5.46484C7.89115 5.23047 8.09297 4.95052 8.09297 4.625C8.09297 4.29948 7.89115 4.01953 7.4875 3.78516L1.47188 0.337891Z"/></svg>En Savoir Plus
											</a>
										</div>
									</div>
								</div>
									...
									<div class="news-card">
										...
										<div class="news-card_description">
											<time datetime="2019-10-12">
												<svg width="15" height="16" viewBox="0 0 15 16" xmlns="http://www.w3.org/2000/svg"><path d="M7.5 0.937988C6.46484 0.937988 5.49316 1.13818 4.58496 1.53857C3.67676 1.9292 2.88086 2.46631 2.19727 3.1499C1.52344 3.82373 0.986328 4.61475 0.585938 5.52295C0.195313 6.43115 0 7.40283 0 8.43799C0 9.47314 0.195313 10.4448 0.585938 11.353C0.986328 12.2612 1.52344 13.0571 2.19727 13.7407C2.88086 14.4146 3.67676 14.9468 4.58496 15.3374C5.49316 15.7378 6.46484 15.938 7.5 15.938C8.53516 15.938 9.50684 15.7378 10.415 15.3374C11.3232 14.9468 12.1143 14.4146 12.7881 13.7407C13.4717 13.0571 14.0088 12.2612 14.3994 11.353C14.7998 10.4448 15 9.47314 15 8.43799C15 7.40283 14.7998 6.43115 14.3994 5.52295C14.0088 4.61475 13.4717 3.82373 12.7881 3.1499C12.1143 2.46631 11.3232 1.9292 10.415 1.53857C9.50684 1.13818 8.53516 0.937988 7.5 0.937988ZM7.5 14.4438C6.67969 14.4438 5.90332 14.2876 5.1709 13.9751C4.43848 13.6528 3.79883 13.2231 3.25195 12.686C2.71484 12.1392 2.28516 11.4995 1.96289 10.7671C1.65039 10.0347 1.49414 9.2583 1.49414 8.43799C1.49414 7.61768 1.65039 6.84131 1.96289 6.10889C2.28516 5.37646 2.71484 4.7417 3.25195 4.20459C3.79883 3.65771 4.43848 3.22803 5.1709 2.91553C5.90332 2.59326 6.67969 2.43213 7.5 2.43213C8.32031 2.43213 9.09668 2.59326 9.8291 2.91553C10.5615 3.22803 11.1963 3.65771 11.7334 4.20459C12.2803 4.7417 12.71 5.37646 13.0225 6.10889C13.3447 6.84131 13.5059 7.61768 13.5059 8.43799C13.5059 9.2583 13.3447 10.0347 13.0225 10.7671C12.71 11.4995 12.2803 12.1392 11.7334 12.686C11.1963 13.2231 10.5615 13.6528 9.8291 13.9751C9.09668 14.2876 8.32031 14.4438 7.5 14.4438ZM7.88086 4.68799H6.75293V9.18506L10.6494 11.5874L11.25 10.606L7.88086 8.58447V4.68799Z"/></svg>9.06.2020
											</time>
											<a href="blog-post.php" class="news-cart_name">1 er signature</a>
											<p>Nouvelle Signature de XXXXX chez BraizeRecords decouvre son univers,sa musique a travers a une interview....</p>
											<a href="blog-post.php" class="read-more">
												<svg width="9" height="10" viewBox="0 0 9 10" xmlns="http://www.w3.org/2000/svg"><path d="M1.47188 0.337891C1.06823 0.103516 0.723177 0.0709635 0.436719 0.240234C0.150261 0.402995 0.00703144 0.71875 0.00703144 1.1875V8.0625C0.00703144 8.53125 0.150261 8.84701 0.436719 9.00977C0.723177 9.17253 1.06823 9.13997 1.47188 8.91211L7.4875 5.46484C7.89115 5.23047 8.09297 4.95052 8.09297 4.625C8.09297 4.29948 7.89115 4.01953 7.4875 3.78516L1.47188 0.337891Z"/></svg>En Savoir Plus
											</a>
										</div>
									...
									<div class="news-card">
										...
										<div class="news-card_description">
											<time datetime="2019-10-14">
												<svg width="15" height="16" viewBox="0 0 15 16" xmlns="http://www.w3.org/2000/svg"><path d="M7.5 0.937988C6.46484 0.937988 5.49316 1.13818 4.58496 1.53857C3.67676 1.9292 2.88086 2.46631 2.19727 3.1499C1.52344 3.82373 0.986328 4.61475 0.585938 5.52295C0.195313 6.43115 0 7.40283 0 8.43799C0 9.47314 0.195313 10.4448 0.585938 11.353C0.986328 12.2612 1.52344 13.0571 2.19727 13.7407C2.88086 14.4146 3.67676 14.9468 4.58496 15.3374C5.49316 15.7378 6.46484 15.938 7.5 15.938C8.53516 15.938 9.50684 15.7378 10.415 15.3374C11.3232 14.9468 12.1143 14.4146 12.7881 13.7407C13.4717 13.0571 14.0088 12.2612 14.3994 11.353C14.7998 10.4448 15 9.47314 15 8.43799C15 7.40283 14.7998 6.43115 14.3994 5.52295C14.0088 4.61475 13.4717 3.82373 12.7881 3.1499C12.1143 2.46631 11.3232 1.9292 10.415 1.53857C9.50684 1.13818 8.53516 0.937988 7.5 0.937988ZM7.5 14.4438C6.67969 14.4438 5.90332 14.2876 5.1709 13.9751C4.43848 13.6528 3.79883 13.2231 3.25195 12.686C2.71484 12.1392 2.28516 11.4995 1.96289 10.7671C1.65039 10.0347 1.49414 9.2583 1.49414 8.43799C1.49414 7.61768 1.65039 6.84131 1.96289 6.10889C2.28516 5.37646 2.71484 4.7417 3.25195 4.20459C3.79883 3.65771 4.43848 3.22803 5.1709 2.91553C5.90332 2.59326 6.67969 2.43213 7.5 2.43213C8.32031 2.43213 9.09668 2.59326 9.8291 2.91553C10.5615 3.22803 11.1963 3.65771 11.7334 4.20459C12.2803 4.7417 12.71 5.37646 13.0225 6.10889C13.3447 6.84131 13.5059 7.61768 13.5059 8.43799C13.5059 9.2583 13.3447 10.0347 13.0225 10.7671C12.71 11.4995 12.2803 12.1392 11.7334 12.686C11.1963 13.2231 10.5615 13.6528 9.8291 13.9751C9.09668 14.2876 8.32031 14.4438 7.5 14.4438ZM7.88086 4.68799H6.75293V9.18506L10.6494 11.5874L11.25 10.606L7.88086 8.58447V4.68799Z"/></svg>8.06.2020
											</time>
											<a href="blog-post.php" class="news-cart_name">BraizeRadio</a>
											<p>Découvre   le media BraizeRadio ,ses ideo , objectifs,histoire etc.....</p>
											<a href="blog-post.php" class="read-more">
												<svg width="9" height="10" viewBox="0 0 9 10" xmlns="http://www.w3.org/2000/svg"><path d="M1.47188 0.337891C1.06823 0.103516 0.723177 0.0709635 0.436719 0.240234C0.150261 0.402995 0.00703144 0.71875 0.00703144 1.1875V8.0625C0.00703144 8.53125 0.150261 8.84701 0.436719 9.00977C0.723177 9.17253 1.06823 9.13997 1.47188 8.91211L7.4875 5.46484C7.89115 5.23047 8.09297 4.95052 8.09297 4.625C8.09297 4.29948 7.89115 4.01953 7.4875 3.78516L1.47188 0.337891Z"/></svg>En Savoir Plus
											</a>
										</div>
				...
				<img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" class="parallax-img animate v-center tt-paroller lazy" data-src="img/paralax-3.png" data-paroller-factor="0.18" data-paroller-type="foreground" alt="bg">
				<img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" class="parallax-img parallax-right v-bottom anim-delay animate tt-paroller lazy" data-src="img/paralax-4.png" data-paroller-factor="0.12" data-paroller-type="foreground" alt="bg">
			</section>
			<!-- End news-section -->
				...
				<div class="container">
					<div class="row">
						<div class="col-12">
							<div class="section-header">
								<h2>Notre Equipe .</h2>
								<p>Chez BraizeRecords, nous pensons que la qualité de vos ingénieurs et producteurs est tout aussi important que la qualité du studio dans lequel vous travaillez.</p>
							</div>
							<div class="engineer-slider"
								 data-slick='{
								 	"slidesToShow": 3,
								 	"swipeToSlide": true,
								 	"adaptiveHeight": true,
								...
								<div class="tt-slide">
									<div class="engineer-card">
										<div class="engineer-card_info">
											<h4>GPA_Boy</h4>
											<p>D.A /Producteur /Réalisateur/Ingénieur Son</p>
											<a href="about.php" class="read-more">
												<svg width="9" height="10" viewBox="0 0 9 10" xmlns="http://www.w3.org/2000/svg"><path d="M1.47188 0.337891C1.06823 0.103516 0.723177 0.0709635 0.436719 0.240234C0.150261 0.402995 0.00703144 0.71875 0.00703144 1.1875V8.0625C0.00703144 8.53125 0.150261 8.84701 0.436719 9.00977C0.723177 9.17253 1.06823 9.13997 1.47188 8.91211L7.4875 5.46484C7.89115 5.23047 8.09297 4.95052 8.09297 4.625C8.09297 4.29948 7.89115 4.01953 7.4875 3.78516L1.47188 0.337891Z"/></svg>Voir Plus
											</a>
										</div>
										<picture>
								...
								<div class="tt-slide">
									<div class="engineer-card">
										<div class="engineer-card_info">
											<h4>Kalio</h4>
											<p>Manager / Ingénieur Son /Scout Talent/Bookeur</p>
											<a href="about.php" class="read-more">
												<svg width="9" height="10" viewBox="0 0 9 10" xmlns="http://www.w3.org/2000/svg"><path d="M1.47188 0.337891C1.06823 0.103516 0.723177 0.0709635 0.436719 0.240234C0.150261 0.402995 0.00703144 0.71875 0.00703144 1.1875V8.0625C0.00703144 8.53125 0.150261 8.84701 0.436719 9.00977C0.723177 9.17253 1.06823 9.13997 1.47188 8.91211L7.4875 5.46484C7.89115 5.23047 8.09297 4.95052 8.09297 4.625C8.09297 4.29948 7.89115 4.01953 7.4875 3.78516L1.47188 0.337891Z"/></svg>Voir Plus
											</a>
										</div>
								...
								<div class="tt-slide">
									<div class="engineer-card">
										<div class="engineer-card_info">
											<h4>Erwan</h4>
											<p>Graphiste / Responsable Communication & Web</p>
											<a href="about.php" class="read-more">
												<svg width="9" height="10" viewBox="0 0 9 10" xmlns="http://www.w3.org/2000/svg"><path d="M1.47188 0.337891C1.06823 0.103516 0.723177 0.0709635 0.436719 0.240234C0.150261 0.402995 0.00703144 0.71875 0.00703144 1.1875V8.0625C0.00703144 8.53125 0.150261 8.84701 0.436719 9.00977C0.723177 9.17253 1.06823 9.13997 1.47188 8.91211L7.4875 5.46484C7.89115 5.23047 8.09297 4.95052 8.09297 4.625C8.09297 4.29948 7.89115 4.01953 7.4875 3.78516L1.47188 0.337891Z"/></svg>Voir Plus
											</a>
										</div>
			...
			<section class="dark-section instagram-section pt-xs-40 pt-md-50 pt-lg-100">
				<div class="container">
					<h2 class="text-center white-color mb-xs-20 mb-md-30">Feed <span class="theme-color">@BraizeRecords</span></h2>
				</div>
